...
public class PRASETO implements IProcessPackage {
    ...
    public DataPackage processPackage(ArrayList<Character> data) {//to be an external class
        ...
        return new DataPackage(address, timestamp.toString(), amp, tmp, pwm, bar, uin, Long.toString(mxBean.getUptime()/1000), Long.toString(mxBean.getUptime()/1000 + UpTime.instance.getPreviousTime()));
    }
}
